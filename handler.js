...
m.reply(`Estas baneado, no puedes usar el bot por dos minutos.`)
user.antispam++        
return
}
...
if (m.limit)
conn.reply(m.chat, `Utilizaste *${+m.limit}* diamantes. 💎`, m, channel)
}
if (m.money)
conn.reply(m.chat, `Utilizaste *${+m.money}* monedas. 🪙`, m, channel)
break
}}} catch (e) {
console.error(e)
} finally {
...
"thumbnail": apii.data, 
"title": [wm, packname, author].getRandom(),
...
restrict: `╭•⌑┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈•⌑\n│🔒     \`𝐀𝐃𝐕𝐄𝐑𝐓𝐄𝐍𝐂𝐈𝐀\`      🔒\n╰•⌑┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈•⌑\n\n『✦』𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙚𝙨𝙩𝙖 𝙙𝙚𝙨𝙖𝙘𝙩𝙞𝙫𝙖𝙙𝙤 𝙥𝙤𝙧 𝙚𝙡 𝙘𝙧𝙚𝙖𝙙𝙤𝙧.`,
    ...
    if (msg) return conn.reply(m.chat, msg, m, channel).then(_ => m.react('🛑'))}
